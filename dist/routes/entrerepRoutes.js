...
const entrerepControllers_1 = require("../controllers/entrerepControllers");
 ...
 */
router.post("/create", entrerepControllers_1.createEntrerep);
/**
 * @swagger
 * /e/update/{id}:
 *   put:
 ...
 *                   type: string
 */
router.put("/update/:id", entrerepControllers_1.updateEntrerep);
/**
 * @swagger
 * /e/delete/{id}:
 *   delete:
 ...
 *         description: Erreur serveur
 */
router.delete("/delete/:id", entrerepControllers_1.deleteEntrerep);
/**
 * @swagger
 * /e/list:
 *   get:
 ...
 *         description: Erreur serveur
 */
router.get("/list", entrerepControllers_1.getAllEntrerep);
