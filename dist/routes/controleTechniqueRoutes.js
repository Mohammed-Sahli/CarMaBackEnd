...
const controleTechniqueControllers_1 = require("../controllers/controleTechniqueControllers");
 ...
 */
router.post('/create', controleTechniqueControllers_1.createControle);
/**
 * @swagger
 * /ct/update/{id}:
 *   put:
 ...
 *         description: Erreur serveur
 */
router.put('/update/:id', controleTechniqueControllers_1.updateControle);
/**
 * @swagger
 * /ct/delete/{id}:
 *   delete:
 ...
 *         description: Erreur serveur
 */
router.delete('/delete/:id', controleTechniqueControllers_1.deleteControle);
/**
 * @swagger
 * /ct/all:
 *   get:
 ...
 *         description: Erreur serveur
 */
router.get('/all', controleTechniqueControllers_1.getAllControle);
